...
const FAQ = [
  ...
  },
  {
    ...
    a: "An AI trading agent built and operated by the founder. Vega, Sirius, Atlas, Altair, and Lyra each run a distinct strategy on a distinct market — and have been trading the founder's own account live for months.",
  },
  {
